...
public static class Const {
    ...
    public static double NAV_LAG = 0.1, NAV_POS_SIG = 0.8, NAV_POS_TAU = 20, NAV_VEL_SIG = 0.08, NAV_VEL_TAU = 4,
        NAV_OBS_DT = 0.05, NAV_OBS_H = 5000, NAV_OBS_SMIN = 2e-3, NAV_WIND_TAU = 1.5, NAV_POLL_TAU = 10,
    ...
    public static double SETTLE_A = 0.005, UNSETTLE_T = 0.4, SETTLE_TMIN = 0.3, SETTLE_TMAX = 120,
        SETTLE_GO = 0.9, SETTLE_TRIP = 0.5, GAS_TRIP_T = 0.3, ULLAGE_OFF = 1e5, ULLAGE_A = 0.008, SLOSH_ZETA = 0.03, SLOSH_MAX = 0.5;
    public static double FLIP_BRAKE = 0.8, FLIP_KW = 4, FLIP_TW = 2.4, SHIP_FLIP_TW = 1.7, FLIP_END = 10, FLIP_OM_END = 8, FLIP_D = 200;
