...
echo Запуск. Клавиши: Tab пульт, F1 подсказка, F3 телеметрия, F4 развёртка, F5 вход,
echo F6 сменить задание, F7 отказы, 1 эфир, 2 борт (ещё раз - следующая камера), 3 свободная,
